...
function Hero() {
  return (
    <section id="home" className="relative min-h-[100vh] overflow-hidden bg-[#FAFAF8]">
      <div className="pointer-events-none absolute left-[clamp(24px,4vw,72px)] top-24 h-px w-16 bg-accent" />

      <motion.div
        className="absolute left-[clamp(24px,5vw,88px)] top-[clamp(116px,15vh,168px)] max-w-[520px] text-[12px] leading-6 text-muted md:text-[13px]"
      ...
      >
        ...
        <p className="mt-8 max-w-[500px] text-[13px] leading-7 text-[#6F6F6F]">
          聚焦消费品牌升级与产品品牌化。
          <br />
      ...
      <motion.div
        className="absolute bottom-[clamp(28px,5vw,72px)] left-[clamp(24px,5vw,88px)] text-[12px] leading-6 text-muted md:text-[13px]"
        initial={{ opacity: 0, y: 18 }}
        animate={{ opacity: 1, y: 0 }}
